/*Lab-30.10.2013 2.Soru Klavyeden girilen 3 basamaklı bir tam sayının rakamlarından elde edilecek en büyük 3 basamaklı tam sayıyı bulup ekrana yazan C programı*/
#include<stdio.h>
#include<conio.h>
int main()
{
